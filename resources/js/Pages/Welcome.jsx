        ...
        <>
            ...
            <div className="max-w-12xl p-0 z-50 relative">
                <div className="h-[100px] w-full px-4 fixed flex bottom-0 rounded-b-md bg-primary/50">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 sm:gap-x-5 items-center w-full lg:px-10">
                        <div className="flex-row items-center">
                            <p className="text-white font-normal text-xs lg:text-sm lg:text-md">
                                Arroquigaray N° 516
                            </p>
                            <p className="text-white font-normal text-xs lg:text-sm lg:text-md">
                                Tel. (02271) 409690
                        ...
                        <div className="flex-row items-center">
                            <p className="text-white font-normal text-xs lg:text-sm flex items-center">
                        ...
                        <div className="flex-row items-center hidden lg:block">
                            ...
                            <p className="text-white font-normal text-xs lg:text-sm lg:flex items-center">
