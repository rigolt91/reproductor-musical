                ...
                <div className="h-[150px] w-full fixed flex bottom-0 rounded-b-md bg-[#027DA2]/50">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-10">
                        <div className="flex items-center">
                            <div className="mt-2">
                                <h6 className="text-white font-normal text-sm lg:text-md">
                                    Arroquigaray N° 516
                                </h6>
                                <h6 className="text-white font-normal text-sm lg:text-md">
                                    Tel. (02271) 409690
                        ...
                        <div className="flex items-center">
                            <div className="my-0.5">
                                <h6 className="text-white font-normal text-sm lg:text-md flex items-center">
                                ...
                                <h6 className="text-white font-normal text-sm lg:text-md flex items-center my-0.5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                        ...
                        <div className="flex items-center">
                            <div className="my-0.5">
                                ...
                                <h6 className="text-white font-normal text-sm lg:text-md lg:flex items-center hidden lg:block">
