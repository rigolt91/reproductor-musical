...
export default function FileInput({ label, type = 'text', className = '', icon='', name='file_upload', description='', file, isFocused = false, errorMessage, ...props }) {
    return (
        <div className="col-span-full">
            <div className="mt-2 flex justify-center rounded-lg bg-gray-100 border-gray-900/25 px-6 py-10">
                <div className="text-center">
                    ...
                    {file
                        ? <div className="text-gray-600 text-sm">{URL.createObjectURL(file)}</div>
                        : <>
